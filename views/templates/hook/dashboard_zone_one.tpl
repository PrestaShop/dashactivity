			...
			{if $gapi_mode}
				<li>
					<span class="data_label">
						<a href="{$link->getAdminLink('AdminModules')|escape:'html':'UTF-8'}&amp;{$gapi_mode}=gapi"><img src="../modules/dashactivity/gapi-logo.gif" width="16" height="16" alt=""/> {l s="Link to your Google Analytics account" mod="dashactivity"}</a>
					</span>
				</li>
			{/if}
			<li>
