...
<section id="dashactivity" class="panel widget{if $allow_push} allow_push{/if}">
		...
		<ul class="data_list_large">
			<li>
				<span class="data_label size_l">
					<a href="{$link->getAdminLink('AdminStats')}&amp;module=statslive">{l s='Online Visitors' mod='dashactivity'}</a>
			...
			<li>
				<span class="data_label size_l">
					<a href="{$link->getAdminLink('AdminCarts')}">{l s='Active Shopping Carts' mod='dashactivity'}</a>
					<small class="text-muted"><br/>
	...
	<section id="dash_pending" class="loading">
		...
		<ul class="data_list">
			<li>
				<span class="data_label"><a href="{$link->getAdminLink('AdminOrders')}">{l s='Orders' mod='dashactivity'}</a></span>
				<span class="data_value size_l">
					<span id="pending_orders"></span>
				</span>
			</li>
			<li>
				<span class="data_label"><a href="{$link->getAdminLink('AdminReturn')}">{l s='Return/Exchanges' mod='dashactivity'}</a></span>
				<span class="data_value size_l">
					<span id="return_exchanges"></span>
				</span>
			</li>
			<li>
				<span class="data_label"><a href="{$link->getAdminLink('AdminCarts')}">{l s='Abandoned Carts' mod='dashactivity'}</a></span>
				<span class="data_value size_l">
					<span id="abandoned_cart"></span>
				</span>
			</li>
			<li>
				<span class="data_label"><a href="{$link->getAdminLink('AdminTracking')}">{l s='Out of Stock Products' mod='dashactivity'}</a></span>
				<span class="data_value size_l">
	...
	<section id="dash_notifications" class="loading">
		...
		<ul class="data_list_vertical">
			<li>
				<span class="data_label"><a href="{$link->getAdminLink('AdminCustomerThreads')}">{l s='New Messages' mod='dashactivity'}</a></span>
				<span class="data_value size_l">
					<span id="new_messages"></span>
				</span>
			</li>
			<li>
				<span class="data_label"><a href="{$link->getAdminLink('AdminModules')}&amp;configure=productcomments&amp;tab_module=front_office_features&amp;module_name=productcomments">{l s='Product Reviews' mod='dashactivity'}</a></span>
				<span class="data_value size_l">
	...
	<section id="dash_customers" class="loading">
		...
		<ul class="data_list">
			<li>
				<span class="data_label"><a href="{$link->getAdminLink('AdminCustomers')}">{l s='New Customers' mod='dashactivity'}</a></span>
				<span class="data_value size_md">
					<span id="new_customers"></span>
				</span>
			</li>
			<li>
				<span class="data_label"><a href="{$link->getAdminLink('AdminStats')}&amp;module=statsnewsletter">{l s='New Subscriptions' mod='dashactivity'}</a></span>
				<span class="data_value size_md">
	...
	<section id="dash_traffic" class="loading">
		...
		<ul class="data_list">
			...
			{/if}
			<li>
				<span class="data_label"><a href="{$link->getAdminLink('AdminStats')}&amp;module=statsforecast">{l s='Visits' mod='dashactivity'}</a></span>
				<span class="data_value size_md">
					<span id="visits"></span>
				</span>
			</li>
			<li>
				<span class="data_label"><a href="{$link->getAdminLink('AdminStats')}&amp;module=statsvisits">{l s='Unique Visitors' mod='dashactivity'}</a></span>
				<span class="data_value size_md">
